...
php "$ROOT_DIR/tests/admin-restriction.php"
php "$ROOT_DIR/tests/context.php"
php "$ROOT_DIR/tests/installation-health.php"
php "$ROOT_DIR/tests/setup-wizard.php"
php "$ROOT_DIR/tests/dashboard-shell.php"
...
test -f "$PLUGIN_DIR/includes/core/class-edutech-admin-restriction.php"
test -f "$PLUGIN_DIR/includes/core/class-edutech-context.php"
test -f "$PLUGIN_DIR/includes/core/class-edutech-installation-health.php"
test -f "$PLUGIN_DIR/includes/core/class-edutech-setup-wizard.php"
test -f "$PLUGIN_DIR/includes/core/class-edutech-dashboard-shell.php"
test -f "$PLUGIN_DIR/assets/css/edutech-control-center.css"
...
grep -q 'class Edutech_Admin_Restriction' "$PLUGIN_DIR/includes/core/class-edutech-admin-restriction.php"
grep -q 'class Edutech_Context' "$PLUGIN_DIR/includes/core/class-edutech-context.php"
grep -q 'class Edutech_Installation_Health' "$PLUGIN_DIR/includes/core/class-edutech-installation-health.php"
grep -q 'class Edutech_Setup_Wizard' "$PLUGIN_DIR/includes/core/class-edutech-setup-wizard.php"
grep -q 'class Edutech_Dashboard_Shell' "$PLUGIN_DIR/includes/core/class-edutech-dashboard-shell.php"
grep -q 'edutech-control-center' "$PLUGIN_DIR/assets/css/edutech-control-center.css"
grep -q "add_shortcode('edutech_setup_wizard'" "$PLUGIN_DIR/public/public.php"
